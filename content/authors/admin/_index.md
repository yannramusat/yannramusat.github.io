...
social:
  - icon: envelope
    icon_pack: fas
    link: 'mailto:yann.ramusat@gmail.com'
    #link: '/#contact'
#  - icon: twitter
#    icon_pack: fab
...
{{< icon name="download" pack="fas" >}} You can download my {{< staticref "uploads/cv.pdf" "newtab" >}}résumé{{< /staticref >}} (in French, PDF format).
